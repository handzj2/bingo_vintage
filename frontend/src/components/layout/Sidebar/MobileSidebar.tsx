...
const mobileNavigation = [
  ...
  { name: 'Pending',  href: '/dashboard/expenses/approval', icon: Clock }, // Shortened name for space
  { name: 'Finance',  href: '/dashboard/finance/reconciliation', icon: Wallet },
...
export default function MobileSidebar() {
  ...
  // Filter mobile items based on role if needed (optional)
  // For simplicity, show all; but you can add role checks if desired.
