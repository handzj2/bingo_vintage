...
interface CreateLoanModalProps {
  onClose: () => void;
  onSuccess: () => void;
  clientId?: string; // Optional - if creating from client page
}

export function CreateLoanModal({ onClose, onSuccess, clientId }: CreateLoanModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        clientId: clientId || 'temp-client-id', // Replace with actual client selection
