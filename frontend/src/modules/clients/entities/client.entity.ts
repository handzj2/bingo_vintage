...
export class Client {
  ...
  @Column({ name: 'reference1_name', nullable: true })
  reference1Name: string;

  @Column({ name: 'reference1_phone', nullable: true })
  reference1Phone: string;

  @Column({ name: 'reference2_name', nullable: true })
  reference2Name: string;

  @Column({ name: 'reference2_phone', nullable: true })
