 ...
 *   - tenants entity:  name, contact_phone, address    (HAS contact_phone)
 ...
 *      t.contact_phone (tenants table DOES have this column per tenant entity).
...
export class ReceiptsService {
  ...
  async getReceiptData(
    ...
    //   tenants:  t.name ✓, t.contact_phone ✓               (tenants HAS contact_phone)
